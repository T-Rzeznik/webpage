...
const MainInterface2: React.FC = () => {
    ...
    for (let index = 0; index < 9; index++) {
      boards.push(
        <Grid item xs={12} sm={6} md={4} lg={3} key={index}>
          <ButtonBase component={Paper} sx={{ p: 3, border: 1, borderColor: 'grey.700', borderRadius: 1, height: '170px', width: '100%', position: 'relative', }} onClick={() => handleClick(index)}>
  ...
  return (
    <Box sx={{ flexGrow: 1, border: 1, borderColor: 'grey.500', borderRadius: 1, width: '80vw' }}>
